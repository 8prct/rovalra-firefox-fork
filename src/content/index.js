import { injectFirefoxPageScripts } from './core/firefox/compat.js';
...
const featureRoutes = [
    ...
    // ponytail: Swagger makes content.js exceed Mozilla's 5MB validator limit.
    // Split this into a lazy extension page if Firefox needs API Docs later.
    // Moderation Panel
    {
        paths: ['/moderation'],
